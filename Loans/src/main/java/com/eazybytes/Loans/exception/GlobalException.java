...
public class GlobalException extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ErrorResponseDto> handleLoanAlreadyExist(LoanAlreadyExistException exception,WebRequest webrequest){
	...
	public ResponseEntity<ErrorResponseDto> handleResponseNotFoundException(ResourceNotFoundException exception,WebRequest webrequest){
