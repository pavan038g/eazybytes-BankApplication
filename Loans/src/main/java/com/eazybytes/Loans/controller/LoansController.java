...
public class LoansController {
	...
	@Autowired
	private LoansContactsInfoDto loansContactsInfoDto;
	@Operation(
	...
	@PostMapping("/create")
	public ResponseEntity<ResponseDto> createNewLoan(@RequestParam @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits") String mobileNumber){
		
		iLoanService.createLoan(mobileNumber);
		
		return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDto(LoanConstants.STATUS_201,LoanConstants.MESSAGE_200 ));
	}
	...
	public ResponseEntity<ResponseDto> deleteLoan(@RequestParam @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits") String mobileNumber){
		 ...
		 boolean isDeleted = iLoanService.deleteLoanDetails(mobileNumber);
	        if(isDeleted) {
	            return ResponseEntity
	                    .status(HttpStatus.OK)
	                    .body(new ResponseDto(LoanConstants.STATUS_200, LoanConstants.MESSAGE_200));
	  ...
	  @Operation(
	    ...
	    public ResponseEntity<LoansContactsInfoDto> getContactInfo() {
	    	logger.debug("Ivoked Loans Contact-info API");
	        return ResponseEntity
	                .status(HttpStatus.OK)
