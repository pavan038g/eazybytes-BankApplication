...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponseDto> handelCustomerAlreadyExistException(CustomerAlreadyExistException exception,WebRequest webRequest){
	...
	public ResponseEntity<ErrorResponseDto> handelResourceNotFoundException(ResourceNotFoundException exception,WebRequest webRequest){
